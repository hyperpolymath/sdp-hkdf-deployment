...
// Replace sdp-hkdf-deployment, Sdp Hkdf Deployment — See README.adoc for details., just run, Sdp Hkdf Deployment started successfully. with actuals
= sdp-hkdf-deployment — Quick Start for Users
:toc:
:toclevels: 2

== What is sdp-hkdf-deployment?

Sdp Hkdf Deployment — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./sdp-hkdf-deployment-portable
----
...
[source]
----
Sdp Hkdf Deployment started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/sdp-hkdf-deployment/wiki
