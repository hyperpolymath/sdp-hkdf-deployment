...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/sdp-hkdf-deployment/security/advisories/new)
...
- This repository (`hyperpolymath/sdp-hkdf-deployment`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/sdp-hkdf-deployment/security/advisories)
...
When using SDP HKDF Deployment, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/sdp-hkdf-deployment/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/sdp-hkdf-deployment/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/sdp-hkdf-deployment/discussions) |
...
*Thank you for helping keep SDP HKDF Deployment and its users safe.* 🛡️
