{
  description = "sdp-hkdf-deployment - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 sdp-hkdf-deployment development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P sdp-hkdf-deployment.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/sdp-hkdf-deployment $out/bin/  # Rust
            # cp bin/sdp-hkdf-deployment $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/sdp-hkdf-deployment";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-sdp-hkdf-deployment" {
