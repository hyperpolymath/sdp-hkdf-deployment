...
# Justfile for sdp-hkdf-deployment
...
doctor:
    @echo "Running diagnostics for sdp-hkdf-deployment..."
...
help-me:
    @echo "=== sdp-hkdf-deployment Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/sdp-hkdf-deployment/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: sdp-hkdf-deployment"
